...
const ServicerCommunity = () => {
    ...
    const fetchPosts = async () => {
        try {
            const response = await axios.get('https://localhost:7080/api/Servicer/posts', {
                headers: {
    ...
    const handlePostSubmit = async (e) => {
        ...
        if (accountId) {
            ...
            try {
                await axios.post('https://localhost:7080/api/Servicer/posts', postData, {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem("token")}`,
                        "Content-Type": "application/json"
                    }
    ...
    const handleCommentSubmit = async (e) => {
        ...
        if (accountId && commentingPostId) {
            ...
            try {
                await axios.post('https://localhost:7080/api/Servicer/comments', commentData, {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem("token")}`,
                        "Content-Type": "application/json"
                    }
    ...
    const handleDeleteComment = async (commentId) => {
        ...
        if (accountId === comment.accountId) {
            try {
                await axios.delete(`https://localhost:7080/api/Servicer/comments/${commentId}`, {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem("token")}`
                    }
                });
    ...
    const handleUpdateComment = async (commentId) => {
        ...
        if (accountId) {
            ...
            try {
                await axios.put(`https://localhost:7080/api/Servicer/comments/${commentId}`, updatedCommentData, {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem("token")}`,
                        "Content-Type": "application/json"
                    }
    ...
    const handleDeleteClick = async (postId, accountId) => {
        ...
        if (currentAccountId === accountId) {
            try {
                await axios.delete(`https://localhost:7080/api/Servicer/posts/${postId}`, {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem("token")}`
                    }
                });
    ...
    const handleUpdatePost = async (postId) => {
        ...
        if (accountId === post.accountId) {
            ...
            try {
                await axios.put(`https://localhost:7080/api/Servicer/posts/${postId}`, updatedPostData, {
                    headers: {
                        Authorization: `Bearer ${localStorage.getItem("token")}`,
                        "Content-Type": "application/json"
                    }
...
export default ServicerCommunity;
